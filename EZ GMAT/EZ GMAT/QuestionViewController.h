...
@interface QuestionViewController : UIViewController<UITableViewDataSource, UITabBarDelegate, UIWebViewDelegate, UIScrollViewDelegate,UIAlertViewDelegate>
@property(nonatomic,strong)QuestionPack *currentPack;
